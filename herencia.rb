...
x = OneTimeAppointment.new('Desafío Latam', 'Trabajo', 14, 30, 4, 6, 2019)
y = DailyAppointment.new('Desafío Latam', 'Educación', 8, 15)
z = MonthlyAppointment.new('NASA', 'Aliens', 8, 15, 23)

puts x.occurs_on?(4, 6, 2019)
puts y.occurs_on?(8, 15)
puts z.occurs_on?(23)